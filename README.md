...
Versie `0.5.281` maakt handmatige actieknoppen statusbewuster. **Advies starten** is alleen beschikbaar wanneer het beste scenario uitvoerbaar is, **Teruglevering naar 0** baseert beschikbaarheid op ingestelde PowerStreams en actuele uitvoer, en **Start** toont via attributen of er PowerStreams of Smart Plugs zijn om aan te sturen.
